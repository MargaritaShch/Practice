...
let string111 = ["banana", "apple", "cherry"];
sortString(string111);//RESULT = a***p***p***l***e
...
let string212 = "The_Stealth-Warrior";
convertStringToCamelCase(string212);
let string222 = "the-stealth-warrior";
convertStringToCamelCase(string222);
...
/*18.Я дам вам целое число. Верните мне фигуру такой же длины и ширины, как целое число. Целое число будет целым числом от 1 до 50.*/
// let out1111 = document.querySelector('.out')
// function getBuildSquad(num){
//   for (i = 1; i <= num; i++) {
//     out1111.innerHTML +="<br>";
//       for(k=1;k<=num;k++){
//         out1111.innerHTML += "+";
//       }    
//   }
...
let string121 ='hello world'
console.log(vowelCount(string121));//RESULT = 3 - DONE
...
let color11 = "FF9933";
let rgb11 = fullCodeColore(color11)
console.log(`r:${rgb11.r}, g:${rgb11.g}, b:${rgb11.b} `);//RESULT = r:255, g:153, b:51 - DONE
...
console.log(onlineStatus(newUser11))//RESULT = { online:['David', 'Bob], offline: ['Lusy'], away:[] } -DONE
...
const student111 = new Student("Alice", 2, 3, 4);
const student222 = new Student("Bob", 2, 3, 4);
const student333 = new Student("Charlie", 2, 3, 4);
const studentsAll = [student111, student222 , student333];

const richestStudentName1 = findRichestStudent(studentsAll);
console.log(richestStudentName1);
...
class Deepclass1 extends Subclass1 {}
 
console.log(Class1.getFoo())
console.log(Subclass1.getFoo())
console.log(Deepclass1.getFoo())
...
let  joe1 = new Person1('Joe');
 joe1.greet('Kate'); // 'Hello Kate, my name is Joe'
...
let b1 = new Block1([2,4,6]);
console.log(b1.getWidth()) // 2
console.log(b1.getLength()) // 4
console.log(b1.getHeight()) // 6
console.log(b1.getVolume()) //48
console.log(b1.getSurfaceArea())//88
...
let n1 = new Double1();
console.log(n1.nextCall())//1
console.log(n1.nextCall())//2
console.log(n1.nextCall())//3
...
let newValue1 = true;
console.log(newValue1.returned())// 'true'
let nu1111 = 11
console.log(nu1111.returned()) // '11'
...
console.log(scoreboard(arr12131))

/*47.Classy Extensions
...
class Animal {
  ...
  talk(sound){
    return console.log(`Mr ${this.animal} makes a noise, Mr ${this.animal} goes ${sound}`)
  }
}
...
let wordUpperCese = new String1('abc')
console.log(wordUpperCese.myNewMethod())// Result = ABC - DONE

/*49.You're going to implement a simple counter class. The counter will start at zero, and every time its incr method is called, it will increase by 1.There's one caveat: Your counter must act like a number and support arithmetic operations and comparisons. You are not required to support equality comparison between two Counter instances. */
class Counter{
  constructor(num){
    this.num = num 
  }
